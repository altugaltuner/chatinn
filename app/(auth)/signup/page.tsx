    ...
    <div className="min-h-screen bg-white dark:bg-black flex flex-col gap-16">
      ...
      <div className="flex justify-center items-center h-full">
        <div className="w-full max-w-md rounded-2xl bg-white/5 p-8 shadow-2xl backdrop-blur-sm">
          ...
          <p className="mb-6 text-sm text-gray-400">Yeni bir hesap oluşturun ve sohbete başlayın</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full rounded-lg bg-emerald-600 px-4 py-3 font-semibold text-white transition hover:bg-emerald-500 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
            >
